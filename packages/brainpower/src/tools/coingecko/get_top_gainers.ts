...
export async function getTopGainers(
  ...
  try {
    ...
    const url = `https://pro-api.coingecko.com/api/v3/coins/top_gainers_losers?vs_currency=usd&duration=${duration}&top_coins=${topCoins}&x_cg_pro_api_key=${process.env.COINGECKO_PRO_API_KEY}`;
