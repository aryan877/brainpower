...
export async function getTrendingPools(
  ...
  try {
    ...
    const url = `https://pro-api.coingecko.com/api/v3/onchain/networks/solana/trending_pools?include=base_token,network&duration=${duration}&x_cg_pro_api_key=${process.env.COINGECKO_PRO_API_KEY}`;
